...
include 'navbar.php';
try{
 $searched_trip_name=$_GET["tripname"];  
 if($searched_trip_name==""){
  echo '<h2 style="margin-left:40%;"> No Matches Found</h2>';
 }
 else{
  //get the hiker id
 ...
 $result1=$db_conn->query("SELECT * FROM hikingpost WHERE title LIKE '$searched_trip_name%'
 OR title LIKE'%$searched_trip_name'");
...
echo "<br>";
  ...
  echo '<h2 style="margin-left:35%;"> No Matches Found</h2>';
