...
//show trips of all the joined groups
 ...
 //GET ALL THE TRIPS OF THE JOINED GROUPS FOR THE CURRENT HIKER
 $result1=$db_conn->query("SELECT * FROM hikingpost,groupmembers WHERE hikingpost.groupID 
 =(SELECT groupmembers.groupID WHERE groupmembers.hikerID='$hiker_id' )  ");
...
echo "<br>";
 ...
 if(count($trips_array)==0){
     echo '<h2 style="margin-left:33%;color:#8B4513">Start Exploring Groups and Enjoy Hiking</h2>';
 }
